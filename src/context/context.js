...
const GithubProvider = ({children})=>{
    ...
    const searchGithubUser = async(user)=>{
        ...
        if(response){
            ...
            setIsLoading(false)
//old repo an dfollowers loading
            // repos and followers link from response.data
        ...
        //new loading using allsettled promise
    ...
    const checkRequests = () =>{
        ...
        .then(({data})=>{
            ...
            if(remaining === 0){
                toggleError(true,'sorry, exceeded your hourly rate limit')
            }
        })
        .catch((err)=>console.log(err))
